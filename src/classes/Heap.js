...
move(index){
  ...
  this.data[index].DOMLeaf.style.top = this.data[index].y + "px";
  this.data[index].DOMLeaf.style.left = this.data[index].x + "px";
  this.data[this.getParentIndex(index)].DOMLeaf.style.top = this.data[this.getParentIndex(index)].y + "px";
  this.data[this.getParentIndex(index)].DOMLeaf.style.left = this.data[this.getParentIndex(index)].x + "px";
  console.log(this.data[index])
  console.log(this.data[this.getParentIndex(index)]);
}
 animate(index){
